...
public class PSOSwarm {
	 ...
	 * @param mapRTable2
	 */
	public PSOSwarm(int particles, int epochs, int dim, double inertia_max, double inertia_min, double cognitive, double social,List<RTable> rtable, HashMap<Integer, List<RTable>> mapRTable, int testCase) {
	...
	public Map<Integer, Double> run(String serviceId) {
		...
		PSOParticle bestParticle = new PSOParticle(PSOSim.PSOParticle.FunctionType.A, "bestParticle", dim, mapRTable,	rtable);
		...
		//bestParticle = new PSOParticle(PSOSim.PSOParticle.FunctionType.A, "bestParticle", nodes, mapRTable, rtable);
		bestParticle.setPosition(bestPosition);
